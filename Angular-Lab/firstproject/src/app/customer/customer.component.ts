...
export class CustomerComponent {
  ...
  AddCustomer() {
    ...
    this.httpc.post("https://localhost:44382/api/Customer",customerdto).subscribe(res=>this.PostSuccess(res),res=>this.PostError(res));
  ...
  getData(){
    console.log("Hi");
    this.httpc.get("https://localhost:44382/api/Customer").subscribe(res=>this.GetSuccess(res),res=>this.GetError(res));
  }
